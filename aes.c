...
void shiftRows(uint8_t buf[]){
  uint8_t aux1,aux2;
  aux1=buf[4]; buf[4]=buf[5]; buf[5]=buf[6]; buf[6]=buf[7]; buf[7]=aux1; // Second row.
  aux1=buf[8]; aux2=buf[9]; buf[8]=buf[10]; buf[9]=buf[11]; buf[10]=aux1; buf[11]=aux2; //Third row.
